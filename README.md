...
- I have a (not so active) blog at [https://blog.mirekk.dev](https://blog.mirekk.dev)
    - The source code for the blog is my [own](https://github.com/MirruK/blog-example). You can host your own version of it if you wish!

## Some things I made

### [blog-example](https://github.com/MirruK/blog-example): This is the source code for the blog template I use for my personal website.
...
### [cnake](https://github.com/MirruK/cnake): A basic snake game implemented for fun and learning.
- Built using only C++ and SDL3.
- The game has rudimentary state handling, texture caching, fps counting, and other small features that you expect by default
in an actual game engine.
...
<!--
**MirruK/MirruK** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
